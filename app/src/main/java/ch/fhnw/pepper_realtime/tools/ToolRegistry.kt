...
import ch.fhnw.pepper_realtime.tools.entertainment.PlayAnimationTool
import ch.fhnw.pepper_realtime.tools.entertainment.PlayMelodyTool
import ch.fhnw.pepper_realtime.tools.entertainment.PlayYouTubeVideoTool
import ch.fhnw.pepper_realtime.tools.games.DrawingGameTool
import ch.fhnw.pepper_realtime.tools.games.MemoryGameTool
import ch.fhnw.pepper_realtime.tools.games.QuizTool
import ch.fhnw.pepper_realtime.tools.games.TicTacToeMoveTool
import ch.fhnw.pepper_realtime.tools.games.TicTacToeStartTool
import ch.fhnw.pepper_realtime.tools.information.GetDateTimeTool
import ch.fhnw.pepper_realtime.tools.information.GetRandomJokeTool
import ch.fhnw.pepper_realtime.tools.information.GetWeatherTool
import ch.fhnw.pepper_realtime.tools.information.SearchInternetTool
import ch.fhnw.pepper_realtime.tools.navigation.ApproachHumanTool
import ch.fhnw.pepper_realtime.tools.navigation.CreateEnvironmentMapTool
import ch.fhnw.pepper_realtime.tools.navigation.FinishEnvironmentMapTool
import ch.fhnw.pepper_realtime.tools.navigation.FollowHumanTool
import ch.fhnw.pepper_realtime.tools.navigation.LookAtPositionTool
import ch.fhnw.pepper_realtime.tools.navigation.MovePepperTool
import ch.fhnw.pepper_realtime.tools.navigation.NavigateToLocationTool
import ch.fhnw.pepper_realtime.tools.navigation.SaveCurrentLocationTool
import ch.fhnw.pepper_realtime.tools.navigation.StopFollowHumanTool
import ch.fhnw.pepper_realtime.tools.navigation.TurnPepperTool
import ch.fhnw.pepper_realtime.tools.vision.AnalyzeVisionTool
