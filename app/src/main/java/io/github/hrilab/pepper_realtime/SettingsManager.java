...
public class SettingsManager {
    ...
    private Set<String> getDefaultEnabledTools() {
        ...
        io.github.hrilab.pepper_realtime.tools.ToolRegistryNew registry = new io.github.hrilab.pepper_realtime.tools.ToolRegistryNew();
    ...
    private void setupFunctionCallsUI() {
        ...
        for (String toolId : registry.getAllToolNames()) {
            ...
            try {
                io.github.hrilab.pepper_realtime.tools.Tool tool = registry.createTool(toolId);
                if (tool != null) {
