        ...
        if (context.hasUi()) {
            ...
            context.getActivity().runOnUiThread(() -> {
                if (!context.getActivity().isFinishing()) {
                    io.github.studerus.pepper_android_realtime.tools.games.MemoryGameDialog memoryGame = 
                        new io.github.studerus.pepper_android_realtime.tools.games.MemoryGameDialog(
                            context.getActivity(), 
                            context,
