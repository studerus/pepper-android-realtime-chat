package io.github.studerus.pepper_android_realtime.tools.entertainment;
...
public class PlayYouTubeVideoTool implements Tool {
    ...
    public String execute(JSONObject args, ToolContext context) throws Exception {
        ...
        try {
            ...
            if (context.hasUi()) {
                context.getActivity().runOnUiThread(() -> io.github.studerus.pepper_android_realtime.managers.YouTubePlayerManager.showYouTubePlayerDialog(
                        context.getActivity(), video,
                        new io.github.studerus.pepper_android_realtime.managers.YouTubePlayerManager.YouTubePlayerCallback() {
                            @Override
