...
public class QuizTool implements Tool {
    ...
    public String execute(JSONObject args, ToolContext context) throws Exception {
        ...
        if (context.hasUi()) {
            ...
            context.getActivity().runOnUiThread(() -> io.github.studerus.pepper_android_realtime.managers.QuizDialogManager.showQuizDialog(
                    context.getActivity(), question, opts, correct,
                    new io.github.studerus.pepper_android_realtime.managers.QuizDialogManager.QuizDialogCallback() {
                        @Override
