 ...
 */
final class NavigationMapCache {
    ...
    NavigationMapCache(Handler mainHandler, CriticalSectionListener criticalSectionListener) {
    ...
    boolean isMapSavedOnDisk(Context appContext) {
        try {
    ...
    Future<Boolean> ensureMapLoadedIfNeeded(
            QiContext qiContext,
            Context appContext,
    ...
    MapTopGraphicalRepresentation getMapTopGraphicalRepresentation() {
        return cachedMapGfx.get();
    }

    ExplorationMap getCachedMap() {
        return cachedMap.get();
    }

    void cacheNewMap(ExplorationMap newMap, Runnable onCached) {
        if (newMap == null) {
    ...
    void cacheNewMap(ExplorationMap newMap) {
