 ...
 */
public class SaveCurrentLocationTool extends BaseTool {
    ...
    public String execute(JSONObject args, ToolContext context) throws Exception {
        ...
        try {
            ...
            Frame robotFrame = ((com.aldebaran.qi.sdk.QiContext) context.getQiContext()).getActuation().robotFrame();
            try {
                Frame mapFrame = ((com.aldebaran.qi.sdk.QiContext) context.getQiContext()).getMapping().mapFrame();
