...
3. That's it! The app supports all Realtime API models:
   - `gpt-realtime-2.1` (Latest GPT-5-class reasoning model with built-in vision ✅, improved speech recognition, configurable reasoning effort: `minimal`, `low`, `medium`, `high`, `xhigh`)
   - `gpt-realtime-2.1-mini` (Faster, lower-cost reasoning model with built-in vision ✅, configurable reasoning effort)
...
3. Deploy one or more of the supported models:
   - `gpt-realtime-2.1` (Latest GPT-5-class reasoning model with built-in vision, improved speech recognition, configurable reasoning effort)
   - `gpt-realtime-2.1-mini` (Faster, lower-cost reasoning model with built-in vision, configurable reasoning effort)
...
- **Enables**: Alternative vision analysis provider (`gpt-realtime-2.1`, `gpt-realtime-2.1-mini`, `gpt-realtime-2`, `gpt-realtime-1.5`, `gpt-realtime`, and `gpt-realtime-mini` have built-in vision, only required for vision analysis with gpt-4o-realtime-preview and gpt-4o-mini-realtime-preview)
